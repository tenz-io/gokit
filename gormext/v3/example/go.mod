module gormext-v3-example

go 1.24

require (
	github.com/tenz-io/gokit/gormext/v3 v3.0.0
...
// The v3 gokit modules are not published yet; resolve gormext/v3 from the
// parent dir and its transitive v3 deps from their sibling dirs (three levels
// up: example -> v3 -> gormext -> repo root), so this example module builds
